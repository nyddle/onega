...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Raffle'
        db.create_table(u'chips_raffle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal(u'chips', ['Raffle'])

        # Deleting field 'PromoCode.win_date'
        db.delete_column(u'chips_promocode', 'win_date')

        # Adding field 'PromoCode.raffle'
        db.add_column(u'chips_promocode', 'raffle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chips.Raffle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Raffle'
        db.delete_table(u'chips_raffle')

        # Adding field 'PromoCode.win_date'
        db.add_column(u'chips_promocode', 'win_date',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PromoCode.raffle'
        db.delete_column(u'chips_promocode', 'raffle_id')
    ...
    models = {
        ...
        u'chips.promocode': {
            ...
            'raffle': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['chips.Raffle']", 'null': 'True', 'blank': 'True'}),
