...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DiscreditedIP.failed_times'
        db.delete_column(u'chips_discreditedip', 'failed_times')

        # Adding field 'DiscreditedIP.failed'
        db.add_column(u'chips_discreditedip', 'failed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DiscreditedIP.blocked'
        db.add_column(u'chips_discreditedip', 'blocked',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'DiscreditedIP', fields ['ip']
        db.create_unique(u'chips_discreditedip', ['ip'])


    def backwards(self, orm):
        # Removing unique constraint on 'DiscreditedIP', fields ['ip']
        db.delete_unique(u'chips_discreditedip', ['ip'])

        # Adding field 'DiscreditedIP.failed_times'
        db.add_column(u'chips_discreditedip', 'failed_times',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DiscreditedIP.failed'
        db.delete_column(u'chips_discreditedip', 'failed')

        # Deleting field 'DiscreditedIP.blocked'
        db.delete_column(u'chips_discreditedip', 'blocked')
