...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phase.date'
        db.alter_column(u'chips_phase', 'date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Phase.date'
        raise RuntimeError("Cannot reverse this migration. 'Phase.date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Phase.date'
        db.alter_column(u'chips_phase', 'date', self.gf('django.db.models.fields.DateField')())
