...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chips_customer', (
            ...
            ('blocked_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.create_table(u'chips_promocode', (
            ...
            ('on_phase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chips.Phase'], null=True)),
            ('prise_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chips.PriseType'], null=True)),
        ))
    ...
    models = {
        ...
        u'chips.customer': {
            ...
            'blocked_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
