...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PromoCode.on_phase'
        db.delete_column(u'chips_promocode', 'on_phase_id')


    def backwards(self, orm):
        # Adding field 'PromoCode.on_phase'
        db.add_column(u'chips_promocode', 'on_phase',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chips.Phase'], null=True, blank=True),
                      keep_default=False)
