...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromoCode.phase'
        db.add_column(u'chips_promocode', 'phase',
    ...
    def backwards(self, orm):
        # Deleting field 'PromoCode.phase'
        db.delete_column(u'chips_promocode', 'phase')
    ...
    models = {
        ...
        u'chips.promocode': {
            ...
            'win_date': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
